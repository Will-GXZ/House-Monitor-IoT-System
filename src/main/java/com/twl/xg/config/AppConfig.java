...
/**
 * Using this class to customize Spring MVC configuration. Notice that in Spring 4, we need to
 * extend <code>WebMvcConfigurerAdapter</code> to do this, but since we are using Spring 5,
 * which supports Java 8, the empty implementations of configuration methods has been moved
 * to <code>WebMvcConfigurer</code> interface, we just need to implement this interface.
 * <p>
 * Also, we register the <code>dataTypeList</code> bean in this class.
 *
...
public class AppConfig implements WebMvcConfigurer {
   ...
   *
   * @return ViewResolver view resolver
   */
  @Bean
